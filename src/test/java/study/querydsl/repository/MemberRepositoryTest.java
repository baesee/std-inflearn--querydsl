...
class MemberRepositoryTest {
    ...
    public void searchTest(){
        ...
        List<MemberTeamDto> memberTeamDtos = memberRepository.search(condition); // 동적 where type
    ...
    public void searchPageSimple(){
        ...
        Page<MemberTeamDto> result = memberRepository.searchPageSimple(condition, pageRequest);// 동적 where type
